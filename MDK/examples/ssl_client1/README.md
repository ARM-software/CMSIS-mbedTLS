...
The only change to the original code is the application entry and the server name
used to establish a connection, the rest of the code has not been changed.
