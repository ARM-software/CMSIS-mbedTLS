...
/*  Keil.MDK-Pro::Network:CORE:IPv4/IPv6 Release:7.13.0 */
...
/*  Keil.MDK-Pro::Network:Interface:ETH:7.13.0 */
#define RTE_Network_Interface_ETH_0     /* Network Interface ETH 0 */

/*  Keil.MDK-Pro::Network:Service:DNS Client:7.13.0 */
#define RTE_Network_DNS_Client          /* Network DNS Client */
/*  Keil.MDK-Pro::Network:Socket:BSD:7.13.0 */
#define RTE_Network_Socket_BSD          /* Network Socket BSD */
/*  Keil.MDK-Pro::Network:Socket:TCP:7.13.0 */
#define RTE_Network_Socket_TCP          /* Network Socket TCP */
/*  Keil.MDK-Pro::Network:Socket:UDP:7.13.0 */
#define RTE_Network_Socket_UDP          /* Network Socket UDP */
/*  Keil::CMSIS Driver:Ethernet MAC:2.10.0 */
